...
\documentclass[%
   a4paper,%
 % letterpaper,%
  11pt,                    % alles ein bisschen grˆﬂer
  oneside,
...
\usepackage{afterpage}  % das problem mit den groﬂen tabellen
\usepackage{url}
...
\areaset[0mm]{147.50mm}{222.75mm}  % tuned areaset ... good tradeoff between pagewidth and paragraph description margin
...
\bibliography{references,IEEEconf}
