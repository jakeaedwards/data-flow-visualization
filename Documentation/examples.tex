...
\begin{figure}
	...
	\includegraphics[scale=0.7]{edge_weights_lesmis.png}
	\caption{A bar chart showing edge weights in the Les Misérables Graph}
\end{figure}
%%%%%%%%%%%%%%%%%% 
...
\begin{figure}
	\centering
	\label{fig:degreefreqlesmis}
	\includegraphics[scale=0.7]{degree_freq_lesmis.png}
	\caption{A scatter plot showing degree frequency in the Les Misérables Graph}
\end{figure}
%%%%%%%%%%%%%%%%%% 